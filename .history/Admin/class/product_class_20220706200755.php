...
class product{
  ...
  public function insert_product(){
    ...
    $product_name = $_POST['cartegory_id'];
    $product_name = $_POST['brand_id'];
    $product_name = $_POST['product_price'];
    $product_name = $_POST['product_price_new'];
    $product_name = $_POST['product_desc'];
    $product_name = $_POST['product_img'];
