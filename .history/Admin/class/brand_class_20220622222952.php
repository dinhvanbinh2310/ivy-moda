...
class brand{
  ...
  public function insert_brand($cartegory_id,$brand_name,$brand_id){
    $query = "INSERT INTO tbl_brand (cartegory_id,brand_name) VALUES('$cartegory_id','$brand_name','$brand_id)'";
