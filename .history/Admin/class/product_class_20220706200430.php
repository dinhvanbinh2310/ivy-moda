...
class product{
  ...
  public function insert_product(){
    $query = "INSERT INTO tbl_product (product_name,cartegory_id,brand_id,product_price,product_price_new,product_desc,product_img) VALUES('$cartegory_id','$brand_name')";
